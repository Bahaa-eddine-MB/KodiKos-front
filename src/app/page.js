  ...
  return (
    <main className="container mx-auto">
      ...
      <section className="pt-20 flex flex-col items-center justify-center">
        ...
        <div className="flex items-center justify-center gap-12 pb-16">
          <OfrreCard
            list={["Feauture 1", "Feauture 2", "Feauture 3"]}
            price={"$29"}
            title={"Annual"}
          />
          <OfrreCard
        ...
        <SliderComponent
          comments={[
            ...
            },
            {
              ...
              role: "Hr manager",
              feedback:
                "tErrorBoundary (webpack-internal:///(ssr)/./node_modules/next/dist/client/components/redirect-boundary.js:71:9)    at RedirectBoundary (webpack-internal:///(ssr)/./node_modules/next/dist/client/components/redirect-boundary.js:79:11)",
            },
            {
              avatar: avatar,
              name: "Hitler",
