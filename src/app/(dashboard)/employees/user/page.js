...
import AddNewTask from "@/components/ProjectsPage/AddNewTask";
      ...
      <main className="mt-14 pb-8">
        <div className="flex gap-4 justify-center items-center w-[40%] ml-3 mb-3">
          ...
          <div>
            ...
            <h2 className="font-medium text-xs text-primary p-2">
              {" "}
              Departement
            </h2>
            <p className="text-mainGray2 w-full">
        ...
        <section className="p-8 border rounded-3xl border-[#E6EDFF] mb-4">
          <div className="flex justify-between items-center mb-6">
            ...
            <div onClick={openOpen}  className="w-11 h-11 rounded-full bg-[#F1F0FC] relative hover:cursor-pointer">
              <Image
                src={addTask}
                alt="add new atsk icon"
        ...
        <section className="p-8 border rounded-3xl border-[#E6EDFF]">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="w-11 h-11 rounded-full bg-[#F1F0FC] relative hover:cursor-pointer">
              <Image
                src={addTask}
                alt="add new atsk icon"
                className=" absolute top-2/4 left-2/4 -translate-x-1/2 -translate-y-1/2"
