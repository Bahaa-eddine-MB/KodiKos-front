...
export default function EmployeCard({name, role, email}) {
  return (
    <div className="pl-3 pr-5 py-3 rounded-md flex gap-3 shadow-light justify-center  transition-all duration-700 group hover:cursor-pointer hover:scale-105 hover:bg-primary hover:bg-opacity-60">
